// Global Black – Version 11.5 (Your Architecture, Corrected and Complete)
...
const USERSCRIPT_TAGS = new Set([
  ...
  'mt-sm','.theme-auto','.container-wrapper','.style-scope'
    ...
    /* ----------  4.  Selector helper (with typo fixed)  ---------- */
    ...
    /* ----------  6.  Flicker-free dynamic styling  ---------- */
...
function processElement(el, excluded) {
  ...
  ruleIndexMap.set(el, true);
    ...
    /* ----------  7.  Mutation observer (lightweight)  ---------- */
    ...
    /* ----------  9.  Picker UI (Correctly Integrated)  ---------- */
